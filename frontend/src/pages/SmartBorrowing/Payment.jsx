        ...
        >
          ...
          <div className="relative z-10 w-full">
            <div className="flex items-center justify-between mb-12 border-b border-white/5 pb-8">
              <h2 className="text-3xl font-display text-white tracking-tight leading-none">Total Amount</h2>
            ...
            <div className="space-y-6 mb-12">
              ...
              <div className="pt-12 mt-12 border-t border-white/10">
                ...
                <div className="flex items-end justify-between">
                  <h3 className="text-6xl md:text-8xl font-display text-white tracking-tighter leading-none decoration-emerald-500/50 decoration-8 underline-offset-[16px]">
                    Rs. {amountToPay}
                  </h3>
