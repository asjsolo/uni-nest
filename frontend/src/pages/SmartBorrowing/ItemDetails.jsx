      ...
      return (
         <div className="bg-white">
            <motion.div
               initial={{ opacity: 0 }}
               animate={{ opacity: 1 }}
               className="max-w-3xl mx-auto bg-white border border-gray-100 rounded-[3rem] p-24 text-center shadow-lg"
            >
               <div className="w-20 h-20 bg-red-50 rounded-[2rem] flex items-center justify-center mx-auto mb-8 text-red-500">
                  <AlertCircle size={40} />
               </div>

               <h2 className="text-3xl font-display font-black text-gray-900 mb-4 tracking-tight uppercase">
                  Item Not Found
               </h2>

               <p className="text-gray-400 font-bold text-xs uppercase tracking-widest mb-12">
                  {error}
               </p>

               <Link
                  to="/buyer/items"
                  className="bg-gray-900 text-white font-black px-10 py-5 rounded-2xl shadow-xl hover:bg-emerald-600 active:scale-95 transition-all text-xs uppercase tracking-widest"
               >
                  Back to Marketplace
               </Link>
            </motion.div>
   ...
   return (
      <div className="bg-white">
         ...
         >
            <Link
               to="/buyer/items"
               className="inline-flex items-center gap-3 text-gray-400 hover:text-emerald-700 transition-colors font-black text-[10px] uppercase tracking-[0.2em] group"
            >
         ...
         <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            <div className="lg:col-span-12 xl:col-span-7 space-y-12">
               <motion.div
                  ...
                  className="bg-white rounded-[3rem] border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-700 overflow-hidden relative group"
               >
                  {/* Item Image */}
                  <div className="relative w-full h-[380px] bg-gray-100 overflow-hidden">
                     ...
                     <div className="absolute top-6 left-6 flex flex-wrap items-center gap-3">
                        <div className="flex items-center gap-2 px-4 py-2 bg-white/90 backdrop-blur-md text-emerald-700 rounded-xl border border-white/70 shadow-sm">
                           <ShieldCheck size={14} />
                        ...
                        <div className="flex items-center gap-2 px-4 py-2 bg-white/90 backdrop-blur-md text-gray-500 rounded-xl border border-white/70 shadow-sm">
                           <Tag size={12} />
                           <span className="text-[10px] font-black uppercase tracking-widest">
                        ...
                        {item.isEmergency && (
                           <div className="flex items-center gap-2 px-4 py-2 bg-red-500 text-white rounded-xl border border-red-400 shadow-sm animate-pulse">
                              <AlertCircle size={14} />
                  ...
                  <div className="bg-white rounded-[2.5rem] p-10 border border-gray-100 group transition-all hover:bg-emerald-50/20 hover:border-emerald-100">
                     <div className="flex items-center gap-4 mb-8">
                        ...
                        <div>
                           ...
                           <p className="text-xl font-display font-black text-gray-900 tracking-tight">
            ...
            <div className="lg:col-span-12 xl:col-span-5 space-y-8">
               ...
               >
                  ...
                  <div className="relative z-10 h-full flex flex-col justify-between">
                     <div className="pb-12 border-b border-white/5 mb-12">
                        ...
                        <p className="text-gray-500 font-black text-[10px] uppercase tracking-[0.2em] mb-4">
                           Price per day
                        </p>

                        <div className="flex items-end gap-3">
                           <h2 className="text-7xl font-display text-white tracking-tighter leading-none decoration-emerald-500 decoration-8 underline-offset-[14px]">
                              Rs. {item.pricePerDay}
                           </h2>

                           <span className="text-emerald-500 font-bold text-sm uppercase tracking-widest mb-2 opacity-60">
                              / Day
                           </span>
                        </div>
                     </div>
                     ...
                     <p className="text-center text-[8px] text-gray-700 font-black mt-10 uppercase tracking-[0.5em] opacity-40">
                        Secured Student-to-Student Exchange
                     </p>
                  </div>
               </motion.div>
               ...
               <div className="bg-emerald-50/30 rounded-[2.5rem] p-10 border border-emerald-100/50 flex flex-col items-center text-center">
                  ...
                  <h4 className="text-sm font-black text-emerald-900 uppercase tracking-widest mb-3">
                     Student Guarantee
                  </h4>

                  <p className="text-[11px] font-bold text-emerald-700/60 leading-relaxed uppercase tracking-tight">
                     All items are verified by students to ensure a safe and reliable exchange within the community.
                  </p>
               </div>
            </div>
         </div>
